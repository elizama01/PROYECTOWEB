  ...
  <v-stepper v-model="e1">
    ...
    <v-stepper-items>
      <v-stepper-content step="1">
        ...
        <router-view
          name="VistaIdentificacion"
          v-on:submit="updatee1($event)"
          v-on:confirmarDatos="updatedatos($event)"
      ...
      <v-stepper-content step="2">
        ...
        <router-view
          name="VistaSeleccionProfesional"
          v-bind:profesional="profesional"
          v-on:nuevoprofesional="updateprofesional($event)"
          v-bind:e1="e1"
          v-on:submit="updatee1($event)"
        ></router-view>
      ...
      <v-stepper-content step="3">
        ...
        <!-- Llamado a al componente con routerlink -->
        <router-view
          name="VistaBusquedaDisponibilidad"
          v-bind:fechas="fechas"
          v-on:nuevofecha="updatefechas($event)"
          v-bind:e1="e1"
          v-on:submit="updatee1($event)"
        ></router-view>
      ...
      <v-stepper-content step="4">
        ...
        <!-- Llamado a al componente con routerlink -->
        <router-view
          name="VistaConfirmacionConsulta"
          v-bind:fechas="fechas"
         v-bind:cliente="cliente"
         v-bind:profesional="profesional"
        ></router-view>
...
export default {
  ...
  methods: {
    ...
    updatefechas: function(newdatos) {
      this.fechas = newdatos;
    }
  }
};
</script>
